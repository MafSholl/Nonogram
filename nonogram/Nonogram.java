...
public class Nonogram extends Observable implements Serializable {
	/**
   ...
   * see https://github.com/mikix/nonogram-db/blob/master/FORMAT.md
	...
	/**
	 * To undo a single move by one step backward
	 * Set the state by making use history of states and moves tracked
	 */
